...
export default function Home() {
  ...
  return <main><header className="topbar"><div><div className="brand"><span className="brand-mark">M</span><strong>MemeToGo</strong><em>Alpha Radar</em></div><p>Smart Money / KOL First · 先看谁在买，再看价格为什么动</p></div><div className="live"><span className="live-dot"/><div><b>LIVE</b><small>{lastAt?new Date(lastAt).toLocaleTimeString("zh-CN",{hour12:false}):"连接中"}</small></div></div></header>
